...
@interface SHArrayTableViewController ()

@property (nonatomic, weak) UITableViewCell *lastSelectedCell;

@end

@implementation SHArrayTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegate arrayTableViewController:self DidSelectIndex:indexPath.row];
}
